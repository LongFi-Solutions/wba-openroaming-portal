...
- Fix SAML authenticator to manually extract standard attributes from the SAMLResponse when complex URI schemas fail to map automatically. This also lets the SAML factory to be able to generated account from Google Workspace (old G Suite)

...
| 1.11.0          | 1.11.1         | Run `php bin/console doctrine:migrations:migrate` to remove unused FreeRADIUS connectivity settings.                                                                                                                                                                                                                                                                                                                                                                                    |
| 1.11.1          | 1.12.0         | Run `php bin/console doctrine:migrations:migrate` to apply new configuration settings.                                                                                                                                                                                                                                                                                                                                                                                                  |
| 1.12.0          | 1.12.1         | Run `php bin/console doctrine:migrations:migrate`. To remove outdated settings from the database. Font files for Inter are now self-hosted under `public/fonts/inter/`. No additional steps required.                                                                                                                                                                                                                                                                                   |

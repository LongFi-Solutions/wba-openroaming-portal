...
| 1.11.1          | 1.11.2         | No migrations required. Font files for Inter are now self-hosted under `public/fonts/inter/`. Fix CI/CD pipeline crash by downloading and serving `tw-elements` JS and CSS assets locally & minor bug fix with add admins page                                                                                                                                                                                                                                                          |

    ...
    protected function resetAdminUser(): void
    {
        ...
        if (!$admin instanceof User) {
          ...
          // Save the event Action using the service
            $this->eventActions->saveEvent($admin, AnalyticalEventType::SUPER_ADMIN_CREATION->value, new DateTime(), []);
            $this->eventActions->saveEvent($admin, AnalyticalEventType::SUPER_ADMIN_VERIFICATION->value, new DateTime(), []);
        }
